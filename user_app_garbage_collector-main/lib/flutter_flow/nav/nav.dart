...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'UpdateLocation',
          path: '/updateLocation',
          builder: (context, params) => UpdateLocationWidget(),
        ),
        FFRoute(
          name: 'Notifications',
          path: '/notifications',
        ...
        FFRoute(
          name: 'TripTracking',
          path: '/tripTracking',
          builder: (context, params) => TripTrackingWidget(
        ...
        FFRoute(
          name: 'updateInitialLocation',
          path: '/updateInitialLocation',
          builder: (context, params) => UpdateInitialLocationWidget(),
        )
