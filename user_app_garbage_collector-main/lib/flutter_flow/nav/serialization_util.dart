    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ReferenceDataRow:
            return ReferenceDataRow(data);
          case GeographyColumnsRow:
            return GeographyColumnsRow(data);
          case MunicipalitiesViewRow:
            return MunicipalitiesViewRow(data);
          case DriversRow:
            return DriversRow(data);
          case TripNotificationDetailsViewRow:
            return TripNotificationDetailsViewRow(data);
          case UserRequestsSummaryViewRow:
            return UserRequestsSummaryViewRow(data);
          case TripsRow:
            return TripsRow(data);
          case UsersRow:
            return UsersRow(data);
          case TripNotificationsRow:
            return TripNotificationsRow(data);
          case TripDetailsViewRow:
            return TripDetailsViewRow(data);
          default:
            return null;
        }
